...
export const models = [
  { capabilities: { documents: true, images: false }, id: 'sonar', name: 'Sonar' },
  { capabilities: { documents: true, images: false }, id: 'sonar-pro', name: 'Sonar Pro' },
  { capabilities: { documents: true, images: false }, id: 'sonar-reasoning', name: 'Sonar Reasoning' },
]

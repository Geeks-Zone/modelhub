...
export const models = [
  { capabilities: { documents: true, images: true }, id: 'openai/gpt-4.1-mini', name: 'GPT-4.1 Mini (GitHub Models)' },
  { capabilities: { documents: true, images: false }, id: 'meta/Llama-3.3-70B-Instruct', name: 'Llama 3.3 70B (GitHub Models)' },
]

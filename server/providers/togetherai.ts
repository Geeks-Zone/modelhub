...
export const models = [
  { capabilities: { documents: true, images: false, tools: true }, id: 'meta-llama/Llama-3.3-70B-Instruct-Turbo', name: 'Llama 3.3 70B (Together)' },
  { capabilities: { documents: true, images: false, tools: true }, id: 'Qwen/Qwen2.5-72B-Instruct-Turbo', name: 'Qwen 2.5 72B (Together)' },
  { capabilities: { documents: true, images: true, tools: true }, id: 'meta-llama/Llama-Vision-Free', name: 'Llama Vision Free (Together)' },
]

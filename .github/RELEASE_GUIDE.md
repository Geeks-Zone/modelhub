...
1. Vá para [Releases](https://github.com/seu-usuario/modelhub/releases)
...
```bash
# Build
docker build -t seu-usuario/modelhub:1.1.0 .
docker build -t seu-usuario/modelhub:latest .

# Push
docker push seu-usuario/modelhub:1.1.0
docker push seu-usuario/modelhub:latest
```
...
📖 Docs: https://github.com/seu-usuario/modelhub
...
Confira em: https://github.com/seu-usuario/modelhub
...
- URL: https://github.com/seu-usuario/modelhub
...
**Changelog completo:** https://github.com/seu-usuario/modelhub/releases/tag/v1.1.0
```
...
https://github.com/seu-usuario/modelhub/compare/v1.0.0...v1.1.0
```
